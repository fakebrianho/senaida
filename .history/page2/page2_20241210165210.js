...
function animate() {
	...
	if (selectFlag) {
		...
		if (PARAMS.LoFi) {
			// Light pink/red with opacity
			material.color.setRGB(0.5, 0.4, 0.8) // Light pink
			material.emissive.setRGB(0.5, 0.4, 0.4)
			material.opacity = 0.4
		} else {
			// Light gold/yellow with opacity
			material.color.setRGB(0.5, 0.45, 0.4) // Light gold
			material.emissive.setRGB(0.5, 0.45, 0.4)
			material.opacity = 0.4
		}
