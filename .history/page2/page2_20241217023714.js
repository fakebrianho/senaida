...
const interactables = []
let selected = null
const loadManager = manager(() => {}, camera, 2)
...
init()
function init() {
	tweak(PARAMS, composer, selected)
	renderer.setSize(window.innerWidth, window.innerHeight)
	...
	meshes.visualizer1 = addVisualizer(
		'/masterAudio/master/1-REBIRTH_short.wav',
		'DISCONNECTED_remix_noise',
		1,
		'REBIRTH'
	)
	meshes.visualizer2 = addVisualizer(
		'/masterAudio/master/2-FRAGILE_short.wav',
	...
	meshes.visualizer5 = addVisualizer(
		'/masterAudio/master/5-WANDERER_short.wav',
		'MIMESIS_remix_noise',
		5,
		'WANDERER'
	)
	meshes.visualizer6 = addVisualizer(
		'/masterAudio/master/6-UNGOD_short.wav',
		'MIMESIS_remix_noise',
		6,
		'UNGOD'
	)
	meshes.visualizer7 = addVisualizer(
		'/masterAudio/master/7-MIMESIS_short.wav',
		'MIMESIS_remix_noise',
		7,
		'MIMESIS'
	)
	meshes.visualizer8 = addVisualizer(
		'/masterAudio/master/8-XTASY_short.wav',
		'MIMESIS_remix_noise',
		8,
		'XTASY'
	)
	meshes.visualizer9 = addVisualizer(
		'/masterAudio/master/9-EXPLOITED_short.wav',
		'MIMESIS_remix_noise',
		9,
		'EXPLOITED'
	)
	meshes.visualizer10 = addVisualizer(
		'/masterAudio/master/10-DEJAVU_short.wav',
		'MIMESIS_remix_noise',
		10,
		'DEJAVU'
	)
	meshes.visualizer11 = addVisualizer(
		'/masterAudio/master/11-JUDGEMENT_short.wav',
		'MIMESIS_remix_noise',
		11,
		'JUDGEMENT'
	)
	meshes.visualizer12 = addVisualizer(
		'/masterAudio/master/12-CLARITY_short.wav',
		'MIMESIS_remix_noise',
		12,
		'CLARITY'
	)
	meshes.visualizer13 = addVisualizer(
		'/masterAudio/master/13-DISCONNECTED_short.wav',
		'MIMESIS_remix_noise',
		13,
		'DISCONNECTED'
	)
	meshes.visualizer14 = addVisualizer(
		'/masterAudio/master/14-111_short.wav',
		'MIMESIS_remix_noise',
		14,
		'111'
	)
	meshes.visualizer15 = addVisualizer(
		'/masterAudio/master/15-WEIGHTLESS_short.wav',
		'MIMESIS_remix_noise',
		15,
		'WEIGHTLESS'
	)
