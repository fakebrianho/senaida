...
function init() {
	...
	// meshes.visualizer1 = addVisualizer('DISCONNECTED_original_demo', 1)
	// meshes.visualizer2 = addVisualizer('FRAGILE_original_demo', 2)
	// meshes.visualizer3 = addVisualizer('JUDGEMENT_original_demo', 3)
	// meshes.visualizer4 = addVisualizer('MIMESIS_original_demo', 4)
	meshes.visualizer1 = addVisualizer('track4', 1)
	meshes.visualizer2 = addVisualizer('track4', 2)
	meshes.visualizer3 = addVisualizer('track4', 3)
	meshes.visualizer4 = addVisualizer('track4', 4)
