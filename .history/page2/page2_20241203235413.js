...
function init() {
	...
	meshes.visualizer[1] = addVisualizer(
		'DISCONNECTED_original_demo',
		'DISCONNECTED_remix_noise',
		1
	)
	meshes.visualizer[2] = addVisualizer(
		'FRAGILE_original_demo',
		'FRAGILE_remixe_noise',
		2
	)
	meshes.visualizer[3] = addVisualizer(
		'JUDGEMENT_original_demo',
		'JUDGEMENT_remix_noise',
		3
	)
	meshes.visualizer[4] = addVisualizer(
		'MIMESIS_original_demo',
		'MIMESIS_remix_noise',
		4
	)

	visGroup.add(meshes.visualizer[1].inner)
	visGroup.add(meshes.visualizer[1].outer)
	visGroup.add(meshes.visualizer[2].inner)
	visGroup.add(meshes.visualizer[2].outer)
	visGroup.add(meshes.visualizer[3].inner)
	visGroup.add(meshes.visualizer[3].outer)
	visGroup.add(meshes.visualizer[4].inner)
	visGroup.add(meshes.visualizer[4].outer)
...
function onClick(event) {
	...
	if (intersects.length > 0) {
		...
		gsap.to(`${meshes.visualizer.object.position}`, {
			x: 0,
			y: 0,
			z: 0,
			duration: 1,
