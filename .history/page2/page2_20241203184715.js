...
function init() {
	...
	visGroup.add(meshes.visualizer5.inner)
	visGroup.add(meshes.visualizer5.outer)
	visGroup.add(meshes.visualizer6.inner)
	visGroup.add(meshes.visualizer6.outer)
