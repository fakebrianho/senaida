...
function animate() {
	...
	meshes.visualizer1.outer.rotation.x += 0.01
	meshes.visualizer2.outer.rotation.y += 0.01
	meshes.visualizer3.outer.rotation.y -= 0.01
	meshes.visualizer4.outer.rotation.z -= 0.01
