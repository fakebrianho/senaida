...
function init() {
	...
	vis.add(meshes.visualizer1.inner)
	vis.add(meshes.visualizer1.outer)
	vis.add(meshes.visualizer2.inner)
	vis.add(meshes.visualizer2.outer)
	vis.add(meshes.visualizer3.inner)
	vis.add(meshes.visualizer3.outer)
	vis.add(meshes.visualizer4.inner)
	vis.add(meshes.visualizer4.outer)
	vis.add(meshes.visualizer5.inner)
	vis.add(meshes.visualizer5.outer)
	vis.add(meshes.visualizer6.inner)
	vis.add(meshes.visualizer6.outer)
	// vis.add(meshes.visualizer2)
	// vis.add(meshes.visualizer3)
	// vis.add(meshes.visualizer4)
	// vis.add(meshes.visualizer5)
	// vis.add(meshes.visualizer6)

	// visualizers.v1 = meshes.visualizer1
	// visualizers.v2 = meshes.visualizer2
	// visualizers.v3 = meshes.visualizer3
	// visualizers.v4 = meshes.visualizer4
	// visualizers.v5 = meshes.visualizer5
	// visualizers.v6 = meshes.visualizer6

	//
	meshes.visualizer1.inner.position.set(0, 2.25, 0)
	meshes.visualizer1.outer.position.set(0, 2.25, 0)
	meshes.visualizer2.inner.position.set(-3.5, 0.0, 0)
	meshes.visualizer2.outer.position.set(-3.5, 0.0, 0)
	meshes.visualizer3.inner.position.set(3.5, 0.0, 0)
	meshes.visualizer3.outer.position.set(3.5, 0.0, 0)
	meshes.visualizer4.inner.position.set(0.0, -2.25, 0)
	meshes.visualizer4.outer.position.set(0.0, -2.25, 0)
...
function animate() {
	...
	// vis.position.x += 1.1
	// meshes.visualizer1.inner.position += 0.1
	// console.log(meshes.visualizer1.inner)
	// meshes.visualizer1.inner.position.x += 0.1
	// meshes.visualizer1.outer.position.x += 0.1
