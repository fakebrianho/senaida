...
function init() {
	...
	meshes.visualizer1 = addVisualizer('song1')
	meshes.visualizer2 = addVisualizer('song2')

	//
	meshes.visualizer1.inner.position.set(0, 1.5, 0)
	meshes.visualizer1.outer.position.set(0, 1.5, 0)
	meshes.visualizer2.inner.position.set(-1.5, 0.0, 0)
	meshes.visualizer2.outer.position.set(-1.5, 0.0, 0)
...
function onMouseMove(event) {
	...
	const intersects = raycaster.intersectObject(interactables[1])
...
function animate() {
	...
	if (audioFlag && meshes.visualizer1) {
		...
		meshes.visualizer1.outer.rotation.x += 0.02
		meshes.visualizer1.inner.rotation.z -= 0.01
		meshes.visualizer1.inner.material.uniforms.uTime.value = eT
		meshes.visualizer1.inner.material.uniforms.uFreq.value = data.frequency
		meshes.visualizer1.inner.material.uniforms.uAmp.value = data.amplitude
		meshes.visualizer1.outer.material.uniforms.uTime.value = eT
		meshes.visualizer1.outer.material.uniforms.uFreq.value = data.frequency
		meshes.visualizer1.outer.material.uniforms.uAmp.value = data.amplitude
	}
