...
export function addVisualizer(url, num) {
	const innerMaterial = new THREE.ShaderMaterial({
		uniforms: {
			...
			uColor1: { value: new THREE.Color(0xf0f0f0) },
			uColor2: { value: new THREE.Color(0x01f9c6) },
		},
		vertexShader: vertex,
	...
	const outerGeometry = new THREE.SphereGeometry(0.4, 16, 16)
	const outerMesh = new THREE.Mesh(outerGeometry, innerMaterial)
	outerMesh.userData.url = `${url}.mp3`
