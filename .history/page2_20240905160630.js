...
function init() {
	...
	//
	meshes.visualizer1.inner.position.set(0, 2.5, 0)
	meshes.visualizer1.outer.position.set(0, 2.5, 0)
	...
	meshes.visualizer4.inner.position.set(0.0, -1.5, 0)
	meshes.visualizer4.outer.position.set(0.0, -1.5, 0)
