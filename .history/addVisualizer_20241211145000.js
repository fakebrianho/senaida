...
export function addVisualizer(url, lowfi, num, name) {
	...
	const ao = t.load('/ice/Stylized_Ice_001_ambientOcclusion.png')
	...
	const translucencyMap = t.load('/ice/Stylized_Ice_001_translucency.png')
	const iceGeometry = new THREE.SphereGeometry(0.28, 128, 128)
	const iceMaterial = new THREE.MeshPhysicalMaterial({
		...
		roughness: 0.1,
		ior: 1.5,
		transmissionMap: translucencyMap,
		transparent: true,
		clearcoat: 1.0,
	...
	ice.userData.url = `/${url}.wav`
	// ice.userData.lf = `${lowfi}.wav`
	ice.userData.name = name
	ice.userData.num = num
