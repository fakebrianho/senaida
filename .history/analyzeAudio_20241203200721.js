export function analyzeAudio(url) {
	...
	function stopAudio() {
		...
		if (prev !== null) {
			...
			if (vis) {
				vis.inner.material.uniforms.uAmp.value = 0
				vis.inner.material.uniforms.uFreq.value = 0
				vis.inner.material.uniforms.uLowF.value = 0
				vis.inner.material.uniforms.uMidF.value = 0
				vis.inner.material.uniforms.uHighF.value = 0
				vis.outer.material.uniforms.uAmp.value = 0
				vis.outer.material.uniforms.uFreq.value = 0
				vis.outer.material.uniforms.uLowF.value = 0
				vis.outer.material.uniforms.uMidF.value = 0
				vis.outer.material.uniforms.uHighF.value = 0
			}
		}
